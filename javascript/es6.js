...
// In Es6 two more loops (for of ) and (for in)
// Rest Parameters
...
//   return total;
// };
// const totalValue = sum(10, 20, 80, 80, 10);
// console.log(totalValue);

const sumOne = function (a, b) {
  console.log(a + b);
};
...
const squareTheNumber = (num) => num * num;

const mySqureResult = squareTheNumber(120);
console.log(mySqureResult);
